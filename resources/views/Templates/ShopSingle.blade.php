                                ...
                                <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                    @if ($product->galleries->count() > 0)
                                        @foreach ($product->galleries as $gallery)
                                            <a href="javascript:void(0);" data-image="{{ publicPath($gallery->image) }}"
                                                data-zoom-image="{{ publicPath($gallery->image) }}"
                                                onclick="changeMainImage('{{ publicPath($gallery->image) }}')">
                                                <img class="blur-up lazyload" src="{{ publicPath($gallery->image) }}"
                                                    alt="{{ $product->name }}">
                                            </a>
                                        @endforeach
                                    @else
                                        <a href="javascript:void(0);" data-image="{{ publicPath($product->image) }}"
                                            data-zoom-image="{{ publicPath($product->image) }}">
                                            <img class="blur-up lazyload" src="{{ publicPath($product->image) }}"
                                                alt="{{ $product->name }}">
                                        </a>
                                    @endif
                                </div>
                            ...
                            <div class="zoompro-wrap product-zoom-right pl-20">
                                <div class="zoompro-span">
                                    <img id="mainProductImage" class="blur-up lazyload zoompro"
                                        data-zoom-image="{{ publicPath($mainImage) }}" alt="{{ $product->name }}"
                                                    ...
                                                    <div class="product-image">
                                                        ...
                                                        <a
                                                            ...
                                                            @php
                                                                ...
                                                                $mainImage =
                                                                    $items->galleries->first()->image ?? $items->image;
                                                            ...
                                                            <img class="hover blur-up lazyload"
                                                                ...
                                                                src="{{ publicPath($mainImage) }}" alt="image"
                                                                title="product">
                                                            <!-- End hover image -->
                                                            <!-- product label -->
                                                            ...
                                                            @if (!empty($items->sale_price) && $discountPercent > 0)
                                                                <div class="product-labels rectangular">
                                                                    <span
                                                                        class="lbl on-sale">-{{ $discountPercent }}%</span>
                                                                    <span class="lbl pr-label1">new</span>
                                                                </div>
                                                            @endif
                                                            <!-- End product label -->
