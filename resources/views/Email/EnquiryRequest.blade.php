                 ...
                 <td>
                    <table border="0" cellpadding="0" cellspacing="0"  style="margin:auto;">
                        <tr>
                                <td align="center" valign="top" id="templatePreheader" style="padding:15px 15px;background: #fa869b;">
                                    <h1 style="color: #fff;">New Enquiry Request By <?php echo $enquiry->name; ?></h1>
                                </td>
                        </tr>
                    </table>
                    <table class="main_info" cellpadding="0" cellspacing="0" style="margin:auto; background: #fff; padding: 0 15px 20px;display: block;" >
                        <tr align="left">
                            ...
                            <th width="150px" style="border: 1px solid #c3c3c3;border-collapse: collapse;">mobile</th>
                            <th width="150px" style="border: 1px solid #c3c3c3;border-collapse: collapse;">Message</th>
                        </tr>
                        <tr align="left">
                            ...
                            <td style="border: 1px solid #c3c3c3;border-collapse: collapse;"><?php echo $enquiry->mobile; ?></td>
                            <td style="border: 1px solid #c3c3c3;border-collapse: collapse;"><?php echo $enquiry->message; ?></td>
                        </tr>          
