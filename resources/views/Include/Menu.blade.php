    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-10 col-sm-8 col-md-5 col-lg-4">
                ...
                <p class="phone-no"><i class="anm anm-phone-s"></i><a href="tel:{{ $details['number'] ?? '' }}">
                        {{ $details['number'] ?? '' }}</a></p>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="{{ route('homePage') }}">
                        <img src="{{ publicPath($headerOption['headerlogo'] ?? null) ?? asset('assets/img/icons/1.png') }}
"
                            height="90px" alt="Belle Multipurpose Html Template" title="Belle Multipurpose Html Template" />
                    </a>
                </div>
                <!--End Desktop Logo-->
                    ...
                    <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        ...
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            ...
                            <li class="lvl1 parent megamenu"><a
                                    href="{{ $headerMenuOption['link_url'] }}">{{ $headerMenuOption['link_name'] }} <i
                                        class="anm anm-angle-down-l"></i></a>
                            </li>
                            @endforeach
                        </ul>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                    <div class="logo">
                        <a href="{{ route('homePage') }}">
                            <img src="{{ $headerOption['headerlogo'] ?? asset('assets/img/icons/1.png') }}" width="90px"
