    ...
    <div class="container-fluid" style= "background-color: #dcdcdc73">
        <div class="row align-items-center">
            ...
            <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                ...
                <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                    ...
                    <ul id="siteNav" class="site-nav medium center hidearrow">
                        <li class="lvl1 parent megamenu"><a href="{{ route('homePage') }}">Home<i class="anm anm-angle-down-l"></i></a>
                        </li>
                        @foreach ($headerMenuOptions as $headerMenuOption)
                        <li class="lvl1 parent megamenu"><a href="{{ $headerMenuOption['link_url'] }}">{{ $headerMenuOption['link_name'] }} <i class="anm anm-angle-down-l"></i></a>
                        </li>
                        @endforeach
                    </ul>
                </nav>
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                <div class="logo">
                    <a href="{{ route('homePage') }}">
                        <img src="{{ $headerOption['headerlogo'] ?? asset('assets/img/icons/1.png') }}" width= "90px" alt="Belle Multipurpose Html Template"
                            title="Belle Multipurpose Html Template" />
                    </a>
                </div>
            </div>
...
<div class="mobile-nav-wrapper" role="navigation">
    ...
    <ul id="MobileNav" class="mobile-nav">
        ...
        @foreach ($headerMenuOptions as $headerMenuOption)
        <li class="lvl1 parent megamenu"><a href="{{ $headerMenuOption['link_url'] }}">{{ $headerMenuOption['link_name'] }} <i class="anm anm-plus-l"></i></a>
        </li>
        @endforeach
