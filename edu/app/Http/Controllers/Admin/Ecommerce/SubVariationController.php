...
class SubVariationController extends Controller
{
    ...
    public function __construct(
        SubVariationService $service,
        CommonService $commonService
    ) {
        $this->service = $service;
        $this->commonService = $commonService;
        $this->serviceName = 'Sub Variation';
        $this->routeName = 'sub-variations';        
    }
    /**
    ...
    {        
        ...
        $view = 'Admin.Ecommerce.SubVariation.List';
            ...
            return Datatables::of($rows)
                ...
                ->addColumn('action', function($row){
                    ...
                    <div class="d-flex gap-4">
                        <a class="btn btn-info" title="Edit" href="'.route($this->routeName.'.edit', $row->id).'?variation_id='.request()->get('variation_id').'">
    ...
    public function create()
    {
        ...
        $view = 'Admin.Ecommerce.SubVariation.AddEdit';
        $routeName = $this->routeName;
        $serviceName = $this->serviceName;
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route($this->routeName.'.index', ['variation_id' => $request->variation_id]);
    }
