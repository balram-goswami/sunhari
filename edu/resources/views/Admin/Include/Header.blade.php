...
<head>
    ...
    <title>{{ isset($setting['meta_title']) ? $setting['meta_title'] : 'Dashboard' }}</title>

    <meta name="keyword" content="{{ isset($setting['meta_keyword']) ? $setting['meta_keyword'] : 'Dashboard' }}" />

    <meta name="description"
        content="{{ isset($setting['meta_description']) ? $setting['meta_description'] : 'Dashboard' }}" />
